    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ url('backend/user-management/edit/'.Auth::guard('web')->user()->id) }}" class="dropdown-item has-icon">
                ...
                <a href="{{ route('backoffice.logout') }}" class="dropdown-item has-icon text-danger">
