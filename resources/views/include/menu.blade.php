<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo (isset($active[1]))?$active[1]:'';?>"><a class="nav-link" href="{{ url('/backend/home/logistics-service') }}"><i class="fas fa-wrench"></i> <span>Logistics Service</span></a></li>
