                                            ...
                                            <div class="row ml-2">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control mb-3"
                                                        ...
                                                        aria-label="Default select example" id="company_type"
                                                    ...
                                                    <div id="boxOther" class="3 box">
                                                        ...
                                                        <input type="text" class="form-control" id="company_type_other"
                                                    ...
                                                    <div id="boxOther" class="3 box" style="display: none">
                                                ...
                                                <div class="col-md-4 mt-2">
                                                    ...
                                                    <select class="form-control mb-3"
                                                        ...
                                                        aria-label="Default select example" id="country_region"
                                                    ...
                                                    <div id="boxOther2" class="Other box">

                                                        <input type="text" class="form-control" id="country_region_other"

                                                            name="country_region_other" placeholder=""

                                                            value="{{ $members->country_region_other }}">

                                                    </div>

                                                    @else

                                                    <div id="boxOther2" class="Other box" style="display: none">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#company_type").change(function () {
                ...
                var selectedBox = $('#company_type').val();
            ...
            $("#country_region").change(function () {
                ...
                var selectedBox = $('#country_region').val();

                if (selectedBox == 'Thailand') {

                    $('#boxOther2').hide();

                } else if (selectedBox == 'Other') {
