                                ...
                                <form action="{{ url('/backend/schedules/add-detail/store/'.$Book->id_booking) }}"
                                    ...
                                    <form
                                        ...
                                        <div class="form-group row ml-4 mt-5">
                                            ...
                                            <label for="" class="col-form-label">&nbsp;&nbsp;&nbsp;&nbsp;From (City, Country/Region) :</label>&nbsp;&nbsp;
                                        ...
                                        <div class="form-group row ml-4 mt-5">
                                            ...
                                            <label for="" class="col-form-label">&nbsp;&nbsp;&nbsp;&nbsp;To (City, Country/Region) :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="form-group row ml-4 mt-5">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="save_datetime" name="save_datetime"
                                        ...
                                        <div class="form-group row ml-4 mt-5">
                                            ...
                                            <label for="" class="col-form-label">&nbsp;&nbsp;&nbsp;&nbsp;Transport Status :</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <?php 
                                            ...
                                            $date = date_create($Schedules->save_datetime);
                                        ...
                                        <div class="form-group row ml-4 mt-5">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="save_datetime" name="save_datetime"
                                                    ...
                                                    value="{{ $dateFormat }}" autocomplete="off">
