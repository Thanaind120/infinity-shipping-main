                        ...
                        <div class="row g-3 pb-2">
                            ...
                            <label for="" class="form-label">Country / Region</label>
                                ...
                                <select class="form-select" name="country_region"
                                    ...
                                    <option {{ (Auth::guard('Member')->user()->country_region == 'Thailand') ? 'selected' : '' }} value="Thailand">Thailand</option>

                                    <option {{ (Auth::guard('Member')->user()->country_region == 'Other') ? 'selected' : '' }} value="Other">Other</option>

                                </select>

                                @if(Auth::guard('Member')->user()->country_region == 'Other')
                                ...
                                <div id="boxOther2" class="Other box2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter text..."
                                        ...
                                        name="country_region_other" value="{{ Auth::guard('Member')->user()->country_region_other }}">
                                ...
                                <div id="boxOther2" class="Other box2" style="display:none;">
