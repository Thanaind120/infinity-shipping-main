                    ...
                    <div class="row gx-0">
                        <div class="col-sm-6 bg-login">
                            <div class="box-login-left text-center">
                                ...
                                <a href="{{ url('/register') }}" class="btn btn-navy rounded-pill px-4">Create account</a>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="box-login-right">
                                ...
                                <form class="row g-3" action="account.php">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="password" class="form-control borderR-6" id="" placeholder="Password">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 text-end">
                                        <a href="#" class="link-primary" data-bs-toggle="modal" data-bs-target="#forgotModal">Forgot Password?</a>
                                    </div>
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-navy rounded-pill w-100 mb-5">Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content borderR-25 p-4">
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-navy rounded-pill px-4">Request password reset</button><br>
        <button type="button" class="btn btn-link text-navy" data-bs-dismiss="modal">Back to login</button>
        </div>
      </div>
    </div>
  </div>
