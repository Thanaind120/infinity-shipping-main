            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="pe-5">
                        ...
                        <h4 class="text-navy fw-bold">INFINITY SHIPPING <span class="text-red">(THAILAND)</span> CO.,LTD</h4>
                        <div class="lineL-red mb-4"></div>
                        <p class="text-justify">Our group is a logistics service provider based in Malaysia with strong presence in Southeast Asia and business coverage over 15 countries.</p>
