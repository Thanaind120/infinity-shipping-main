                ...
                <div class="col-md-3">
                    <a href="{{ url('/landLogistics') }}">
                        <div class="box-service mb-3">
                            <div class="box-img">
                                <div class="img-bg"
                                    style="background-image:url('frontend/images/service/cover-LandLogistics.png');">
                                </div>
                ...
                <div class="col-md-3">
                    <a href="{{ url('/nvocc') }}">
                        <div class="box-service mb-3">
                            <div class="box-img">
                                <div class="img-bg"
                                    style="background-image:url('frontend/images/service/cover-NVOCC.png');"></div>
                                <div class="hover-container">
                                    <div class="icon">
                                        <i class='bx bx-search'></i>
                                    </div>
                ...
                <div class="col-md-3">
                    <a href="{{ url('/freightForwarding') }}">
                        <div class="box-service mb-3">
                            <div class="box-img">
                                <div class="img-bg"
                                    style="background-image:url('frontend/images/service/cover-FreightForwarding.png');">
                                </div>
                                <div class="hover-container">
                                    <div class="icon">
                                        <i class='bx bx-search'></i>
                ...
                <div class="col-md-3">
                    <a href="{{ url('/bulkLogistics') }}">
                        <div class="box-service mb-3">
                            <div class="box-img">
                                <div class="img-bg"
                                    style="background-image:url('frontend/images/service/cover-BulkLogistics.png');">
                                </div>
                                <div class="hover-container">
                                    <div class="icon">
                                        <i class='bx bx-search'></i>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel owl-theme" id="clientSlide">
                ...
                <div class="item text-center">
                    <img src="{{ $val->img_logo != '' ? asset('backend/assets/img/logo/' . $val->img_logo) : asset('backend/assets/img/logo/nopic.jpg') }}" class="" alt="">
                </div>
                @endforeach
            </div>
        </div>
